...
#define OVF_TIM1   8                           //время переполнения таймера1, мс
...
#define KSTATE     2                           //количество проверок при сканировании кнопок

#define EEP_ADDR 0x000                         //начальный адрес в EEPROM
