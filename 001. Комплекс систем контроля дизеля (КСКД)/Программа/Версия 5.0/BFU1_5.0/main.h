...
#define KEY_BT     0x08                        //считываемое значение при 'TOGGLE'  (0000 1000) 2-й бит = 0
#define KEY_BS     0x04                        //считываемое значение при 'SAVE'    (0000 0100) 3-й бит = 0
#define KEY_EMPTY  0                           //не нажато
#define KSTATE     5                           //количество проверок при сканировании кнопок

#define EEP_ADDR   50                          //начальный адрес в EEPROM

const unsigned char NumberAdNew[4]={1,2,3,0};  //массив номеров каналов АЦП
const unsigned int ustavki[7] = {t4_8, t4_30, t4_37, t5_37, t5_95, t5_118, t6_115};
/*==========================================================================================================================*/
