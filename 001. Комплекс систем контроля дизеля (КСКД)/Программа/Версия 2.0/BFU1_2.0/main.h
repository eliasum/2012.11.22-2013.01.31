...
unsigned int  array[9];                                                 //оцифрованные уставки для порогов датчиков температуры и давления
...
unsigned char toggle;                                                   //флаг нажатия кнопки переключения режима работы
unsigned char save;                                                     //флаг нажатия кнопки сохранения константы в EEPROM
...
unsigned char count_channel;                                            //номер канала индикации и записи калибровочной константы
