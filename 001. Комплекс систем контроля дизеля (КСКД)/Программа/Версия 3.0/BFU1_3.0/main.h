...
#define EEPROM_START_ADDRESS 255
#define ADDRESS_TO_EE        (uint16_t *)(count_channel + EEPROM_START_ADDRESS)
#define ADDRESS_FROM_EE      (&eememory[i] + EEPROM_START_ADDRESS)

const unsigned char NumberAdNew[4]={1,2,3,0};  //массив номеров каналов АЦП
const unsigned int ustavki[9] = {t4_8, t4_30, t4_37, t5_37, t5_95, t6_115, t5_118, d1_1, d1_4};
/*==========================================================================================================================*/
...
unsigned int  array[9];                                                 //оцифрованные уставки в ОЗУ
unsigned int  from_ee[9];                                               //оцифрованные уставки, считанные из EEPROM
unsigned int  eememory[9] EEMEM;                                        //массив адресов уставок в EEPROM
